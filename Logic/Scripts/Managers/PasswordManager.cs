...
namespace OpenMMO.Groundwork
{
	...
	// ===================================================================================
	// PasswordManager
	// Based on the Open-Source Script "Secure Password Storage v2.0"
	// https://github.com/defuse/password-hashing
	// BSD 2-Clause "Simplified" License
	/// <summary>
	/// This server-side class is responsible for generating and validating account
	/// passwords.
	/// </summary>
	// ===================================================================================
	[DisallowMultipleComponent]
    public partial class PasswordManager : BaseServerBehaviour
    {
